...
class AccountMoveLine(models.Model):
    ...
    def _get_price_total_and_subtotal_model(
        ...
        if taxes:
            ...
            # result["amount_untaxed"] = taxes_res["total_excluded"]
            # result["amount_tax_not_included"] = taxes_res['amount_tax_not_included']
            # result["amount_taxed"] = taxes_res["total_included"]
