...
class AccountMoveLine(models.Model):
    ...
    def _get_price_total_and_subtotal_model(
        ...
        insurance_value = self.env.context.get("insurance_value") or 0
        other_value = self.env.context.get("other_value") or 0
        freight_value = self.env.context.get("other_value") or 0
