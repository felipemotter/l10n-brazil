...
class TestReturnImport(SavepointCase):
    ...
    def _assert_move_entries(self, expected_move_line_values, moves):
        for move in moves:
            for return_log_move in move.cnab_return_log_id.move_ids:
                for line_index, expected in enumerate(expected_move_line_values):
                    move_line = return_log_move.line_ids[line_index]
                    self.assertEqual(
                        expected["account_name"], move_line.account_id.name
                    )
    ...
    def test_valor_menor_1(self):
        ...
        self._assert_move_entries(expected_move_line_values, move)
    ...
    def test_valor_menor_2(self):
        ...
        self.assertEqual(4, len(move.cnab_return_log_id.move_ids))
        self.assertEqual(3.6, move.cnab_return_log_id.amount_total_tariff_charge)
        self.assertEqual(1000.0, move.cnab_return_log_id.amount_total_title)
        expected_move_line_values = [
            {
