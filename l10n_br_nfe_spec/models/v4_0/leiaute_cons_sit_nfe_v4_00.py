...
class InfEvento(models.AbstractModel):
    ...
    nfe40_CPF = fields.Char(string="CPF", xsd_type="TCpf")
...
class InfEvento(models.AbstractModel):
    ...
    nfe40_CNPJDest = fields.Char(string="CNPJ Destinatário", xsd_type="TCnpjOpc")

    nfe40_CPFDest = fields.Char(string="CPF Destiantário", xsd_type="TCpf")
