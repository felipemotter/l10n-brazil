...
class TconsSitNfe(models.AbstractModel):
    ...
    nfe40_xServ = fields.Selection(TCONSSITNFE_XSERV,
        xsd_required=True,
        string="Serviço Solicitado"
    )
    ...
    nfe40_versao = fields.Selection(TVERCONSSITNFE,
...
class InfEvento(models.AbstractModel):
    ...
    nfe40_cOrgao = fields.Selection(TCORGAOIBGE,
...
class TretConsSitNfe(models.AbstractModel):
    ...
    nfe40_procEventoNFe = fields.One2many("nfe.40.tprocevento", "nfe40_procEventoNFe_TRetConsSitNFe_id",
