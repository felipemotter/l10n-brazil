...
class TenderEmi(models.AbstractModel):
    ...
    nfe40_UF = fields.Selection(TUFEMI,
        xsd_type="TUfEmi",
        xsd_required=True,
        string="Sigla da UF"
    )
    nfe40_CEP = fields.Char(
        xsd_required=True,
        string="CEP - NT 2011/004"
    )
    nfe40_cPais = fields.Selection(TENDEREMI_CPAIS,
        string="Código do país"
    )
    nfe40_xPais = fields.Selection(TENDEREMI_XPAIS,
        string="Nome do país"
    )
    nfe40_fone = fields.Char(
...
class TretConsReciNfe(models.AbstractModel):
    ...
    nfe40_protNFe = fields.One2many("nfe.40.tprotnfe", "nfe40_protNFe_TRetConsReciNFe_id",
        xsd_type="TProtNFe",
...
class InfNfe(models.AbstractModel):
    ...
    nfe40_autXML = fields.One2many("nfe.40.autxml", "nfe40_autXML_infNFe_id",
        string="Pessoas autorizadas para o download do XML da NF",
        help="Pessoas autorizadas para o download do XML da NF-e"
    )
    nfe40_det = fields.One2many("nfe.40.det", "nfe40_det_infNFe_id",
    ...
    nfe40_Id = fields.Char(
        xsd_required=True,
        string="PL_005d - 11/08/09 - validação do Id"
    )
...
class Ide(models.AbstractModel):
    ...
    nfe40_mod = fields.Selection(TMOD,
        xsd_type="TMod",
        xsd_required=True,
    ...
    nfe40_tpImp = fields.Selection(IDE_TPIMP,
        xsd_required=True,
    ...
    nfe40_tpEmis = fields.Selection(IDE_TPEMIS,
        xsd_required=True,
    ...
    nfe40_finNFe = fields.Selection(TFINNFE,
        xsd_type="TFinNFe",
        xsd_required=True,
    ...
    nfe40_indFinal = fields.Selection(IDE_INDFINAL,
        xsd_required=True,
    ...
    nfe40_indPres = fields.Selection(IDE_INDPRES,
        xsd_required=True,
        string="indPres",
        help=(
    ...
    nfe40_indIntermed = fields.Selection(IDE_INDINTERMED,
    ...
    nfe40_procEmi = fields.Selection(TPROCEMI,
        xsd_type="TProcEmi",
        xsd_required=True,
    ...
    nfe40_NFref = fields.One2many("nfe.40.nfref", "nfe40_NFref_ide_id",
...
class RefNf(models.AbstractModel):
    ...
    nfe40_mod = fields.Selection(REFNF_MOD,
        xsd_required=True,
        string="Código do modelo do Documento Fiscal",
        help=(
...
class RefNfp(models.AbstractModel):
    ...
    nfe40_mod = fields.Selection(REFNFP_MOD,
        xsd_required=True,
        string="Código do modelo do Documento Fiscal",
        help=(
...
class Emit(models.AbstractModel):
    ...
    nfe40_CRT = fields.Selection(EMIT_CRT,
        xsd_required=True,
...
class Avulsa(models.AbstractModel):
    ...
    nfe40_xOrgao = fields.Char(
        xsd_required=True,
        string="Órgão emitente"
    )
    nfe40_matr = fields.Char(
        xsd_required=True,
        string="Matrícula do agente"
    )
...
class Dest(models.AbstractModel):
    ...
    nfe40_indIEDest = fields.Selection(DEST_INDIEDEST,
        xsd_required=True,
...
class Prod(models.AbstractModel):
    ...
    nfe40_indEscala = fields.Selection(PROD_INDESCALA,
        string="indEscala"
    )
    ...
    nfe40_indTot = fields.Selection(PROD_INDTOT,
        xsd_required=True,
    ...
    nfe40_DI = fields.One2many("nfe.40.di", "nfe40_DI_prod_id",
        string="Delcaração de Importação",
        help="Delcaração de Importação\n(NT 2011/004)"
    )
    nfe40_detExport = fields.One2many("nfe.40.detexport", "nfe40_detExport_prod_id",
    ...
    nfe40_rastro = fields.One2many("nfe.40.rastro", "nfe40_rastro_prod_id",
        string="rastro"
    )
...
class Di(models.AbstractModel):
    ...
    nfe40_UFDesemb = fields.Selection(TUFEMI,
        xsd_type="TUfEmi",
        xsd_required=True,
    ...
    nfe40_tpViaTransp = fields.Selection(DI_TPVIATRANSP,
        xsd_required=True,
    ...
    nfe40_tpIntermedio = fields.Selection(DI_TPINTERMEDIO,
        xsd_required=True,
    ...
    nfe40_UFTerceiro = fields.Selection(TUFEMI,
        xsd_type="TUfEmi",
    ...
    nfe40_adi = fields.One2many("nfe.40.adi", "nfe40_adi_DI_id",
...
class VeicProd(models.AbstractModel):
    ...
    nfe40_VIN = fields.Selection(VEICPROD_VIN,
        xsd_required=True,
    ...
    nfe40_condVeic = fields.Selection(VEICPROD_CONDVEIC,
        xsd_required=True,
    ...
    nfe40_tpRest = fields.Selection(VEICPROD_TPREST,
        xsd_required=True,
        string="Restrição",
        help=(
            "Restrição\n0 - Não há;\n1 - Alienação Fiduciária;\n2 - "
...
class Arma(models.AbstractModel):
    ...
    nfe40_tpArma = fields.Selection(ARMA_TPARMA,
        xsd_required=True,
...
class Comb(models.AbstractModel):
    ...
    nfe40_UFCons = fields.Selection(TUF,
        xsd_type="TUf",
        xsd_required=True,
...
class Pisst(models.AbstractModel):
    ...
    nfe40_indSomaPISST = fields.Selection(PISST_INDSOMAPISST,
...
class Cofinsst(models.AbstractModel):
    ...
    nfe40_indSomaCOFINSST = fields.Selection(COFINSST_INDSOMACOFINSST,
...
class Icmsufdest(models.AbstractModel):
    ...
    nfe40_pICMSInter = fields.Selection(ICMSUFDEST_PICMSINTER,
        xsd_required=True,
...
class Icmspart(models.AbstractModel):
    ...
    nfe40_CST = fields.Selection(ICMSPART_CST,
        xsd_required=True,
    ...
    nfe40_modBC = fields.Selection(ICMSPART_MODBC,
        xsd_required=True,
    ...
    nfe40_modBCST = fields.Selection(ICMSPART_MODBCST,
        xsd_required=True,
    ...
    nfe40_UFST = fields.Selection(TUF,
        xsd_type="TUf",
        xsd_required=True,
...
class Icmsst(models.AbstractModel):
    ...
    nfe40_CST = fields.Selection(ICMSST_CST,
        xsd_required=True,
    ...
    nfe40_vBCFCPSTRet = fields.Monetary(
        ...
        string="vBCFCPSTRet",
        help=(
            "Informar o valor da Base de Cálculo do FCP retido anteriormente "
            "por ST."
        )
    )
...
class Issqn(models.AbstractModel):
    ...
    nfe40_cListServ = fields.Selection(TCLISTSERV,
        xsd_type="TCListServ",
        xsd_required=True,
        string="cListServ",
        help=(
    ...
    nfe40_indISS = fields.Selection(ISSQN_INDISS,
        xsd_required=True,
    ...
    nfe40_indIncentivo = fields.Selection(ISSQN_INDINCENTIVO,
        xsd_required=True,
...
class Issqntot(models.AbstractModel):
    ...
    nfe40_cRegTrib = fields.Selection(ISSQNTOT_CREGTRIB,
...
class Transp(models.AbstractModel):
    ...
    nfe40_transporta = fields.Many2one(
        ...
        comodel_name="nfe.40.transporta"
    )
    ...
    nfe40_reboque = fields.One2many("nfe.40.tveiculo", "nfe40_reboque_transp_id",
        xsd_type="TVeiculo",
    ...
    nfe40_vol = fields.One2many("nfe.40.vol", "nfe40_vol_transp_id",
...
class Vol(models.AbstractModel):
    ...
    nfe40_lacres = fields.One2many("nfe.40.lacres", "nfe40_lacres_vol_id",
        string="lacres"
    )
...
class Cobr(models.AbstractModel):
    ...
    nfe40_dup = fields.One2many("nfe.40.dup", "nfe40_dup_cobr_id",
...
class DetPag(models.AbstractModel):
    ...
    nfe40_indPag = fields.Selection(DETPAG_INDPAG,
...
class InfAdic(models.AbstractModel):
    ...
    nfe40_obsCont = fields.One2many("nfe.40.obscont", "nfe40_obsCont_infAdic_id",
    ...
    nfe40_obsFisco = fields.One2many("nfe.40.obsfisco", "nfe40_obsFisco_infAdic_id",
    ...
    nfe40_procRef = fields.One2many("nfe.40.procref", "nfe40_procRef_infAdic_id",
...
class ProcRef(models.AbstractModel):
    ...
    nfe40_indProc = fields.Selection(PROCREF_INDPROC,
        xsd_required=True,
...
class Cana(models.AbstractModel):
    ...
    nfe40_forDia = fields.One2many("nfe.40.fordia", "nfe40_forDia_cana_id",
    ...
    nfe40_deduc = fields.One2many("nfe.40.deduc", "nfe40_deduc_cana_id",
...
class TenviNfe(models.AbstractModel):
    ...
    nfe40_indSinc = fields.Selection(TENVINFE_INDSINC,
        xsd_required=True,
        string="Indicador de processamento síncrono",
        help="Indicador de processamento síncrono. 0=NÃO; 1=SIM=Síncrono"
    )
    nfe40_NFe = fields.One2many("nfe.40.tnfe", "nfe40_NFe_TEnviNFe_id",
        xsd_type="TNFe",
        string="NFe"
    )
    nfe40_versao = fields.Char(
